...
async def play(client: Client, message_: Message):
    ...
    res = await message_.reply_text("🔄 Mmm dekhti hoon dear...")
    ...
    if audio:
        ...
        if offset == None:
            await res.edit_text("❕ kuch toh do bhai.")
            return
    ...
    if is_playing:
        ...
        await res.edit_text("▶️ basanti iss kutton ke samne gaana...")
